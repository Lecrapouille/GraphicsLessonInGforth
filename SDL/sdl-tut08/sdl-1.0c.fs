...
\ sdl-set-gamma                      *** Not Ready For Prime Time ***
\ sdl-get-gamma-ramp                 *** Not Ready For Prime Time ***
\ sdl-set-gamma-ramp                 *** Not Ready For Prime Time ***
\ sdl-map-rgb                        *** Not Ready For Prime Time ***
\ sdl-map-rgba                       *** Not Ready For Prime Time ***
\ sdl-get-rgb                        *** Not Ready For Prime Time ***
\ sdl-get-rgba                       *** Not Ready For Prime Time ***
\ sdl-creatergbsurface  ( flags w h bpp Rm Gm Bm Am -- *surface )
\ sdl-creatergbsurfacefrom           *** Not Ready For Prime Time ***
\ sdl-freesurface       ( *surface -- )
\ : sdl-mustlock        { *src -- f }       -- in Forth code, not C++
\ sdl-locksurface       ( *surface -- f )
\ sdl-unlocksurface     ( *surface -- )
\ sdl-loadbmp           ( *filename -- *surface )
\ sdl-savebmp                        *** Not Ready For Prime Time ***
\ sdl-set-colorkey       ( *surface flag key -- f )
\ sdl-set-alpha                      *** Not Ready For Prime Time ***
\ sdl-set-clip-rect                  *** Not Ready For Prime Time ***
\ sdl-get-clip-rect                  *** Not Ready For Prime Time ***
\ sdl-convert-surface                *** Not Ready For Prime Time ***
\ sdl-blitsurface       ( *src *srcrect *dst *dstref -- f )
\ sdl-fillrect          ( *dst *dstrect color -- f )
\ sdl-display-format                 *** Not Ready For Prime Time ***
\ sdl-display-format-alpha           *** Not Ready For Prime Time ***
\ sdl-warp-mouse                     *** Not Ready For Prime Time ***
\ sdl-create-cursor                  *** Not Ready For Prime Time ***
\ sdl-free-cursor                    *** Not Ready For Prime Time ***
\ sdl-set-cursor                     *** Not Ready For Prime Time ***
\ sdl-get-cursor                     *** Not Ready For Prime Time ***
\ sdl-show-cursor       ( toggle -- status )
\ sdl-gl-load-library                *** Not Ready For Prime Time ***
\ sdl-gl-get-proc-address            *** Not Ready For Prime Time ***
...
[else]
.( [set %sdl-quiet flag to 1 to view these messages])cr
