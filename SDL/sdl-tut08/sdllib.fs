...
: SDLLib-Version ( -- )
  ." +-------------------------------------------------+" cr
  ." |   SDLLib v1.0c 03/12/2010 by Timothy Trussell   |" cr
  ." +-------------------------------------------------+" cr
;
...
: Splash-Screen ( -- )
  640x480x32 s" SDL Library v1.0c" InitGraph  \ create display window
  s" sdllib-10c.png0" Terminate-String sdl-loadimage     \ load image
