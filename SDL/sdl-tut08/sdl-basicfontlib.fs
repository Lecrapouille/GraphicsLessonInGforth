...
\ ===================================================================
\ This is being coded for 256 color modes, but should be able to be
\ expanded to the 16- 24- and 32-bit modes easily
\ ===================================================================
...
: GFBox { _x1 _y1 _x2 _y2 _fg _bg _type -- }
  ...
  _type 14 < if
    ...
    font-getsurface box% _bg sdl-fillrect
  else
    _y2 _y1 1+ do
      _x2 _x1 1+ do
...
\ ---[ font-init ]---------------------------------------------------
\ Called after InitGraph, to calculate specifics for the font code
\ If the system hangs after trying to display text, then it is likely
\ that this was not called.
