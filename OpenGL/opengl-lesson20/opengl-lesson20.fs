...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 200" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     m     - toggles masking"                    1+
  cr ."     SPACE - toggles the scene to display"       1+
  cr                                                    1+
...
cr .( gforth/OpenGL: NeHe Lesson 20)
cr .( type "lesson20" to execute) cr
