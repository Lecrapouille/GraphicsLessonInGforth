...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 20" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 2)
cr .( type "lesson02" to execute) cr
