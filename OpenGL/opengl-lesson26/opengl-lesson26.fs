...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 26: Using The Stencil Buffer0"
...
: Help-Msg ( -- )
  ...
  cr ."     a     move object towards viewer"           1+
  cr ."     z     move object away from viewer"         1+
  cr ."  Arrow Keys:"                                   1+
  cr ."     Up       increases x-speed"                 1+
  cr ."     Dn       decreases x-speed"                 1+
...
cr .( gforth/OpenGL: NeHe Lesson 26)
cr .( type "lesson26" to execute) cr
