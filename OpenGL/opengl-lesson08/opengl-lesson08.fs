...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 80" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     b        toggles blending on/off"           1+
...
cr .( gforth/OpenGL: NeHe Lesson 8)
cr .( type "lesson08" to execute) cr
