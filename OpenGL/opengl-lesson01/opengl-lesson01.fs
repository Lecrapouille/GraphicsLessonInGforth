...
\ ===================================================================
\               OpenGL Tutorial Lesson 01 BaseCode
\ ===================================================================
...
: Init-Video ( -- )
  ...
  then
  to screen                                 \ save to surface pointer
;

\ Put a title onto the window caption bar
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 10" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 1)
cr .( type "lesson01" to execute) cr
