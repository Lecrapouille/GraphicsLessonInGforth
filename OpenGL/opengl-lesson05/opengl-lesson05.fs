...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 50" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 5)
cr .( type "lesson05" to execute) cr
