...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 230" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     b        toggles bumps"                     1+
  cr ."     e        toggles embossing"                 1+
  cr ."     f        cycles through filters"            1+
  cr ."     m        toggles multitextured support"     1+
  cr ."     PgUp     zooms into the screen"             1+
  cr ."     PgDn     zooms out of the screen"           1+
  cr ."  Arrow Keys:"                                   1+
  cr ."     Up       increases x rotation speed"        1+
  cr ."     Dn       decreases x rotation speed"        1+
  cr ."     Right    increases y rotation speed"        1+
  cr ."     Left     decreases y rotation speed"        1+
...
cr .( gforth/OpenGL: NeHe Lesson 23)
cr .( type "lesson23" to execute) cr
