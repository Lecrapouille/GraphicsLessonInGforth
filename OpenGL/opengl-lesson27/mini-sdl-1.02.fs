...
c-function sdl-img-load         IMG_Load                       a -- a

\ These have been added for completeness of the library 
c-function sdl-img-geterror     IMG_GetError                     -- a
c-function sdl-img-init         IMG_Init                       n -- n
c-function sdl-img-loadbmp-rw   IMG_LoadBMP_RW                 a -- a
c-function sdl-img-loadcur-rw   IMG_LoadCUR_RW                 a -- a
c-function sdl-img-loadgif-rw   IMG_LoadGIF_RW                 a -- a
c-function sdl-img-loadico-rw   IMG_LoadICO_RW                 a -- a
c-function sdl-img-loadjpg-rw   IMG_LoadJPG_RW                 a -- a
c-function sdl-img-loadlbm-rw   IMG_LoadLBM_RW                 a -- a
c-function sdl-img-loadpcx-rw   IMG_LoadPCX_RW                 a -- a
c-function sdl-img-loadpng-rw   IMG_LoadPNG_RW                 a -- a
c-function sdl-img-loadpnm-rw   IMG_LoadPNM_RW                 a -- a
c-function sdl-img-loadtga-rw   IMG_LoadTGA_RW                 a -- a
c-function sdl-img-loadtif-rw   IMG_LoadTIF_RW                 a -- a
c-function sdl-img-loadxcf-rw   IMG_LoadXCF_RW                 a -- a
c-function sdl-img-loadxv-rw    IMG_LoadXV_RW                  a -- a
c-function sdl-img-loadxpm-rw   IMG_LoadXPM_RW                 a -- a
c-function sdl-img-load-rw      IMG_Load_RW                  a n -- a
c-function sdl-img-loadtyped-rw IMG_LoadTyped_RW           a n a -- a

c-function sdl-img-quit         IMG_Quit                      -- void
c-function sdl-img-seterror     IMG_SetError                a -- void
...
1 constant IMG_MAJOR_VERSION
2 constant IMG_MINOR_VERSION
8 constant IMG_PATCHLEVEL
