...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 60" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 6)
cr .( type "lesson06" to execute) cr
