...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 120" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."   Arrow Keys:"                                  1+
  cr ."     Left  make x rotation more negative"        1+
  cr ."     Right make x rotation more positive"        1+
  cr ."     Up    make y rotation more negative"        1+
  cr ."     Down  make y rotation more positive"        1+
  cr                                                    1+
...
cr .( gforth/OpenGL: NeHe Lesson 12)
cr .( type "lesson12" to execute) cr
