...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 40" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 4)
cr .( type "lesson04" to execute) cr
