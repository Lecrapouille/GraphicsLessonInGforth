...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 180" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     f        cycle thru the different filters"  1+
  cr ."     l        toggles the light on/off"          1+
  cr ."     SPACE    cycle thru the different objects"  1+
...
cr .( gforth/OpenGL: NeHe Lesson 18)
cr .( type "lesson18" to execute) cr
