...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 110" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 11)
cr .( type "lesson11" to execute) cr
