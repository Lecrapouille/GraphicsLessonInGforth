...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 160" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     g        cycle thru the different fogs"     1+
...
cr .( gforth/OpenGL: NeHe Lesson 16)
cr .( type "lesson16" to execute) cr
