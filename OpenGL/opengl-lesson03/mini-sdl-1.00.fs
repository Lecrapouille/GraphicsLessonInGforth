...
\ --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
\ This is a *lot* like a C UNION-type definition, but not identical.
\ --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
...
\ which reads in the data for the next event that has occurred.
\ --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
...
\ ====================================================[07/04/2010]===
\ This is the major change, as the sdl-event% STRUCT is actually a
\ C UNION type, with it being defined as large as the biggest STRUCT
\ that it references
\ ===================================================================
...
sdl-event-type%
  1 32 field sdl-event-data      \ actually 20 bytes, but I padded it
