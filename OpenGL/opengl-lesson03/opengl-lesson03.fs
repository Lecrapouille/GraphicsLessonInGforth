...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 30" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 3)
cr .( type "lesson03" to execute) cr
