...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 25: Morphing and Loading Objects0"
...
: Help-Msg ( -- )
  ...
  cr ."     SPACE resets display variables to initial"  1+
  cr ."     PgUp  increase z-speed"                     1+
  cr ."     PgDn  decrease z-speed"                     1+
  cr ."     w     move object up"                       1+
  cr ."     s     move object down"                     1+
  cr ."     a     move object left"                     1+
  cr ."     d     move object right"                    1+
  cr ."     z     move object towards viewer"           1+
  cr ."     q     move object away from viewer"         1+
  cr ."     1..4  morphs to different objects"          1+
  cr ."  Arrow Keys:"                                   1+
  cr ."     Up       decreases x-speed"                 1+
  cr ."     Dn       increases x-speed"                 1+
  cr ."     Left     decreases y-speed"                 1+
  cr ."     Right    increases y-speed"                 1+
...
cr .( gforth/OpenGL: NeHe Lesson 25)
cr .( type "lesson25" to execute) cr
