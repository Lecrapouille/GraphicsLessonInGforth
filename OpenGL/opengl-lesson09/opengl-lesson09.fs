...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 90" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     t        toggles twinkling of starts"       1+
  cr ."   Arrow Keys:"                                  1+
  cr ."     Up       changes tilt of the start"         1+
  cr ."              (more negative)"                   1+
  cr ."     Down     changes tilt of the start"         1+
  cr ."              (more positive)"                   1+
  cr                                                    1+
...
cr .( gforth/OpenGL: NeHe Lesson 9)
cr .( type "lesson09" to execute) cr
