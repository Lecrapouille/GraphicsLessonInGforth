...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 190" zstring NULL sdl-wm-set-caption
;
...
: Help-Msg ( -- )
  ...
  cr ."     TAB      resets all particles"               1+
  cr ."     RETURN   toggles the rainbow color effect"   1+
  cr ."     SPACE    turns off rainbowing cycles colors" 1+
  cr ."   Arrow Keys:"                                   1+
  cr ."     Up       increase particles y movement"      1+
  cr ."     Down     decrease particles y movement"      1+
  cr ."     Right    increase particles x movement"      1+
  cr ."     Left     decrease particles x movement"      1+
  cr ."   Numeric Keypad:"                               1+
  cr ."     KP-Plus  speeds up the particles"            1+
  cr ."     KP-Minus slows down the particles"           1+
  cr ."     KP-8     increase particles y gravity"       1+
  cr ."     KP-2     decrease particles y gravity"       1+
  cr ."     KP-6     increase particles x gravity"       1+
  cr ."     KP-4     decrease particles x gravity"       1+
  cr                                                     1+
  cr ." Mouse Functions: The usuals..."                  1+
  cr                                                     1+
...
: lesson19 ( -- )
  ...
  while
    ...
    rainbow rainbow-delay 25 > AND if
    ...
    \ Increment the rainbow delay count
    rainbow-delay 1+ to rainbow-delay

\    3 sdl-delay           \ delay to allow the demo screen to be seen
...
cr .( gforth/OpenGL: NeHe Lesson 19)
cr .( type "lesson19" to execute) cr
