...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 220" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 22)
cr .( type "lesson22" to execute) cr
