...
: Init-Caption ( -- )
  s" gforth/OpenGL: NeHe Lesson 170" zstring NULL sdl-wm-set-caption
;
...
cr .( gforth/OpenGL: NeHe Lesson 17)
cr .( type "lesson17" to execute) cr
